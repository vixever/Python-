...
class HTMLRenderer(Handler):
    ...
    def start_document(self):
        print('<html><head><title>SjiYanLou</title></head><body>')
    ...
    def sub_url(self, match):
        return '<a target="_blank" style="text-decoration: none;color:\
         #BC1A4B;" href="%s">%s</a>' % (match.group(1), match.group(1))
